...
import Data_GAME_CONSTANTS
import Data_RESEARCH
import Data_TECH_TABLE
import Data_GOVERNMENTS
...
PLANETS_SPECIALS = {
    Data_GAME_CONSTANTS.SPECIAL_ARTIFACTS: {
        'research_bonus':        +2,
    }
}
...
DEFAULT_RULES = {
    ...
    'research':            Data_RESEARCH.RESEARCH,
    'research_areas':      Data_RESEARCH.RESEARCH_AREAS,
    'tech_table':          Data_TECH_TABLE.TECH_TABLE,
    'buildings':           Data_BUILDINGS.BUILDINGS,
    'governments':         Data_GOVERNMENTS.GOVERNMENTS,
}
